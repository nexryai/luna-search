...
RUN apt update && apt upgrade -y \
 && apt install git python3 python3-venv python3-pip libboost-all-dev mecab mecab-ipadic sqlite3 python3-dev libboost-dev libmecab-dev libsqlite3-dev build-essential -y \
 && pip install --break-system-packages -r requirements.txt \
 && pip install git+https://github.com/searxng/searxng \
