...
RUN apt update && apt upgrade -y \
 && apt install git python3 python3-venv python3-pip libmecab2 libboost-regex libboost-system libboost-filesystem mecab mecab-ipadic sqlite3 python3-dev libboost-dev libboost-all-dev libboost-regex-dev libmecab-dev libsqlite3-dev build-essential -y \
